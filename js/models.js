...
const modelsConfig = {
    ...
    models: [
        ...
        },
        {
            ...
            provider: 'openrouter',
            avatar: 'images/AI/gemini.png',
            description: '$0.15/M输入 / $3.50/M输出',
            tooltip: 'Google 2025年5月20日',
        ...
        },
        {
            ...
            provider: 'openrouter',
            avatar: 'images/AI/chatgpt.png',
            description: '$1.50/M输入 / $6/M输出',
            tooltip: 'OpenAI 2025年5月14日',
            date: new Date('2025-05-14'),
            sortOrder: 86,
            apiConfig: {
        ...
        },
        {
            ...
            provider: 'openrouter',
            avatar: 'images/AI/mistral.png',
            description: '$0.07/M输入 / $0.10/M输出',
            tooltip: 'Mistral 2025年5月21日',
    ...
    requireLoginForModels: [
        ...
        'openai/o1', 'openai/gpt-4o-2024-11-20', 'openai/gpt-4', 'openai/codex-mini',
        ...
        'google/gemini-2.5-flash-preview-05-20:thinking', 'google/gemini-2.5-flash-preview-05-20',
        ...
        'minimax/minimax-01', 'inflection/inflection-3-productivity', 'thedrummer/valkyrie-49b-v1'
    ]
};
